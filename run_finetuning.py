...
def main():
    ...
    os_model_name = "Helsinki-NLP/opus-mt-en-hi"
    ...
    if model_args.model_name_or_path is None:
        ...
        model = MarianMTModel.from_pretrained(model_args.model_name_or_path)
    ...
    def preprocess_function(examples):
        inputs = [str(source) for source in examples[source_lang]]
        targets = [str(target) for target in examples[target_lang]]
